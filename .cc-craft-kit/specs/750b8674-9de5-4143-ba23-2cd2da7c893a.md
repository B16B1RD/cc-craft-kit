...
updated_at: "2025-12-06T12:30:00+09:00"
---
...
- [x] `.claude/commands/cft/spec.md` のケース B セクションを修正
  - [x] ステップ 2 の後に「作業ブランチを develop にマージ」を追加
  - [x] ステップ 3 の後に「develop をプッシュ」を追加
  - [x] コンフリクト発生時のエラーハンドリングを追加
