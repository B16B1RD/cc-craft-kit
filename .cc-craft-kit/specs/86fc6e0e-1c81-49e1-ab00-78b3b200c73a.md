...
- [ ] `.claude/commands/cft` シンボリックリンクを削除 (#690)
- [ ] `src/slash-commands/*.md` を `.claude/commands/cft/` にコピー (#691)
- [ ] `src/skills/` ディレクトリを作成し、スキル定義を移動 (#692)
- [ ] `src/agents/` ディレクトリを作成し、エージェント定義を移動 (#693)

### Phase 2: 不要ファイル削除

- [ ] `.cc-craft-kit/scripts/` から開発用スクリプトを削除 (#694)
- [ ] `.cc-craft-kit/slash-commands/` ディレクトリを削除 (#695)
- [ ] `.cc-craft-kit/quality-templates/` ディレクトリを削除 (#696)
- [ ] `.cc-craft-kit/backups/` ディレクトリを削除 (#697)
