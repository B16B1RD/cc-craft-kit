---
id: "86fc6e0e-1c81-49e1-ab00-78b3b200c73a"
name: "インストール構成の見直し"
phase: "completed"
branch_name: "develop"
github_issue_number: null
pr_url: null
created_at: "2025-12-04T09:15:06.463Z"
updated_at: "2025-12-04T19:55:00Z"
---
...
- [x] `sync-dogfood.ts` の同期先を `.claude/commands/cft/` に変更 (#698)
- [x] スキル・エージェントの同期処理を追加 (#699)
- [x] 不要ファイル削除処理を追加 (#700)

### Phase 4: インストールスクリプト更新

- [x] `install.sh` からシンボリックリンク作成処理を削除 (#701)
- [x] アーカイブ展開後の構成を更新 (#702)

### Phase 5: リリースワークフロー更新

- [x] `release.yml` のアーカイブ作成処理を更新 (#703)
- [x] `.claude/` ディレクトリをアーカイブに含める (#704)
- [x] 不要ファイルを除外する処理を追加 (#705)

### Phase 6: ドキュメント・設定更新

- [x] `.gitignore` に `.claude/commands/cft/`、`.claude/skills/`、`.claude/agents/` を追加 (#706)
- [x] `README.md` のインストール手順・構成図を更新 (#707)
- [x] `docs/QUICK_START.md` のセットアップ手順を更新 (#708)
- [x] `docs/ARCHITECTURE.md` のアーキテクチャ図を更新 (#709)
- [x] `CLAUDE.md` の構成説明を更新 (#710)
---
...
- https://github.com/B16B1RD/cc-craft-kit/pull/711
---
