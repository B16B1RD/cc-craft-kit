...
- [ ] .cc-craft-kit/cc-craft-kit-new.db を削除する (#714)
- [ ] .cc-craft-kit/cc-craft-kit-recovered.db を削除する (#715)
- [ ] .cc-craft-kit/test-archive.tar.gz を削除する (#716)

### Phase 2: sync-dogfood.ts の改善

- [ ] cleanUnusedFiles() 関数を追加する (#717)
- [ ] syncAll() に cleanUnusedFiles() を統合する (#718)
