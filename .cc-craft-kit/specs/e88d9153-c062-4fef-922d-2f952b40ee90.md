...
- [ ] package.json の version を "0.1.6" に更新 (#601)
- [ ] CHANGELOG.md に [0.1.6] セクションを追加 (#602)
- [ ] npm run sync:dogfood で同期 (#603)

### Phase 2: 品質チェック

- [ ] npm run typecheck で型チェック成功を確認 (#604)
- [ ] npm run lint でリントチェック成功を確認 (#605)
- [ ] npm test で全テスト成功を確認（Node 18, 20） (#606)
- [ ] npm run check:sync で同期確認成功を確認 (#607)
- [ ] npm audit でセキュリティチェック成功を確認 (#608)
