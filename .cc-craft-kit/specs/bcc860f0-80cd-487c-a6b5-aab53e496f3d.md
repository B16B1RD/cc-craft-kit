...
pr_url: "https://github.com/B16B1RD/cc-craft-kit/pull/956"
created_at: "2025-12-07T07:00:00.000Z"
updated_at: "2025-12-07T09:00:00.000Z"
---
...
- [x] status.md の Step 2 を Grep ツールベースの集計に変更
- [x] status.md から TypeScript 依存（npx tsx）を削除
- [x] spec.md の list サブコマンドで `^phase:` パターンを使用するよう修正
- [x] 動作確認: `/cft:status` で正しいフェーズ件数が表示されることを確認
- [x] 動作確認: `/cft:spec list design` で design フェーズの仕様書のみが表示されることを確認
