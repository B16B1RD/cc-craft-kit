...
- [ ] DEFAULT_STATUS_MAPPING の implementation を 'In Progress' に変更 (#592)
- [ ] DEFAULT_STATUS_MAPPING の completed を 'In Review' に変更 (#593)
- [ ] github-status-config.test.ts のテスト期待値を更新 (#594)
- [ ] phase-status-mapper.test.ts のテスト期待値を更新 (#595)

### Phase 2: PR マージ後処理の実装

- [ ] github-integration.ts の spec.pr_merged ハンドラに Projects ステータス更新を追加 (#596)
