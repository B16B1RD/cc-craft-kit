---
id: "a1e6e12a-693a-49ff-9b73-848b55402b85"
name: "git clone せずともインストールできるようにしたい"
phase: "completed"
branch_name: "main"
github_issue_number: null
pr_url: null
created_at: "2025-11-17T18:17:32Z"
updated_at: "2025-11-17T18:44:40Z"
---
...
現在の cc-craft-kit インストール方法は以下の手順が必要です。
...
**インストールスクリプトのみ**で、指定したプロジェクトディレクトリに cc-craft-kit を導入できるようにします。
...
- Git 操作なしで、任意のプロジェクトに cc-craft-kit を導入
...
- **試用ユーザー**: cc-craft-kit をすぐに試したいユーザー
...
- cc-craft-kit アップデート機能（`/cft:upgrade`）
- プラグインマーケットプレイス
