---
id: "54d9ca55-f77c-40ef-80cc-a87facf4cd10"
name: "インストール方法が間違っている"
phase: "completed"
branch_name: "develop"
github_issue_number: null
pr_url: null
created_at: "2025-12-02T05:19:38.072Z"
updated_at: "2025-12-03T00:12:00Z"
---
...
- [x] README.md のインストールセクションを curl + GitHub raw URL 推奨に変更 (#520)
- [x] docs/QUICK_START.md のインストールセクションを curl + GitHub raw URL 推奨に変更 (#521)
- [x] scripts/install.sh のヘルプ・コメント内の URL を GitHub raw URL に修正 (#522)
---

## Pull Request

- https://github.com/B16B1RD/cc-craft-kit/pull/523
