...
- [ ] `src/slash-commands/spec-create.md` に Step 4.5（ベースブランチの決定）を追加
- [ ] `src/slash-commands/spec-create.md` の Step 5 を修正（BASE_BRANCH から派生）
- [ ] エラーハンドリングセクションに BASE_BRANCH 関連のエラーを追加

### Phase 2: テスト追加

- [ ] `tests/slash-commands/spec-create.test.ts` に BASE_BRANCH 参照テストを追加
- [ ] `npm test` で全テスト合格確認
