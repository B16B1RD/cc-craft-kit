...
- [ ] Step 8.0 追加: 現在のブランチを確認する処理を追加 (#776)
- [ ] Step 8.1 追加: 削除対象ブランチとの同一判定ロジックを追加 (#777)
- [ ] Step 8.2 追加: ベースブランチへの自動切り替え処理を追加（未コミット変更の自動コミット含む） (#778)
- [ ] 既存 Step 8 の処理を Step 8.3 以降にリナンバリング (#779)

### Phase 2: 動作確認

- [ ] npm run sync:dogfood で同期 (#780)
- [ ] npm run typecheck && npm run lint で品質チェック (#781)
- [ ] 手動テスト: 作業ブランチで completed 移行が成功することを確認 (#782)
