---
id: "4bd9226d-0184-4bf6-b62c-ccd53ca94516"
name: "旧名称の Takumi が残存している"
phase: "completed"
branch_name: "develop"
github_issue_number: null
pr_url: null
created_at: "2025-12-02T05:46:12.236Z"
...
- [x] templates/design.md.hbs のフッタを cc-craft-kit に置換 (#525)
- [x] templates/tasks.md.hbs のフッタを cc-craft-kit に置換 (#526)
- [x] templates/requirements.md.hbs のフッタを cc-craft-kit に置換 (#527)

### Phase 2: LICENSE ファイル置換

- [x] LICENSE の著作権表記を cc-craft-kit Project Contributors に置換 (#528)

### Phase 3: 仕様書ファイル置換

- [x] .cc-craft-kit/specs/ 配下の全仕様書ファイルから Takumi 参照を cc-craft-kit に置換 (#529)

### Phase 4: package.json 更新

- [x] package.json から replace:takumi, migrate:takumi 関連の npm scripts を削除 (#530)

### Phase 5: 旧移行スクリプト削除

- [x] src/scripts/migrate-takumi-to-cc-craft-kit.ts を削除 (#531)
- [x] src/scripts/replace-takumi-references.ts を削除 (#532)
- [x] src/scripts/rename-project.ts を削除 (#533)

### Phase 6: 検証・完了

- [x] npm run sync:dogfood で同期実行 (#534)
- [x] npm run typecheck で型チェック実行 (#535)
- [x] npm test でテスト実行 (#536)
- [x] grep -r "Takumi" で残存確認 (#537)

## Pull Request

- https://github.com/B16B1RD/cc-craft-kit/pull/539
