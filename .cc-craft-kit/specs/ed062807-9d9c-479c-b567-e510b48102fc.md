---
id: "ed062807-9d9c-479c-b567-e510b48102fc"
name: "CLI コマンドの見直し"
phase: "completed"
branch_name: "main"
github_issue_number: null
pr_url: null
created_at: "2025-11-16T14:36:47Z"
updated_at: "2025-11-17T01:01:28Z"
---
...
cc-craft-kit は当初、CLI コマンド（`takumi` コマンド）とカスタムスラッシュコマンド（`/cft:*`）の両方を提供していたが、実際の利用形態として Claude Code 上でのカスタムスラッシュコマンドのみが想定されている。CLI コマンドは以下の理由で不要と判断:
...
- cc-craft-kit 開発者（現在は 1 名のみ）
- 将来的に cc-craft-kit を利用する Claude Code ユーザー
