...
- [ ] spec-create.md Step 4.5 のコマンドを単一パイプラインに変更 (#495)
- [ ] spec-create.md Step 4.5 の説明文を更新 (#496)

### Phase 2: spec-phase.md の修正

- [ ] spec-phase.md Step 3.1 のコマンドを単一パイプラインに変更 (#497)

### Phase 3: 同期と確認

- [ ] `npm run sync:dogfood` で同期 (#498)
- [ ] 動作確認（/cft:spec-create、/cft:spec-phase） (#499)
