---
id: "84314ae7-7c50-4811-978a-23224a72ed04"
name: "v0.1.7 リリース準備作業"
phase: "completed"
branch_name: "develop"
github_issue_number: null
pr_url: null
created_at: "2025-12-04T05:06:19.019Z"
...
- [x] npm run sync:dogfood で .cc-craft-kit/ へ同期 (#640)
- [x] npm run typecheck で型チェック実行 (#641)
- [x] npm run lint で ESLint チェック実行 (#642)
- [x] npm test でテスト実行 (#643)
- [x] npm run check:sync で同期チェック実行 (#644)
- [x] npm audit でセキュリティチェック実行 (#645)
---

## Pull Request

- https://github.com/B16B1RD/cc-craft-kit/pull/646
