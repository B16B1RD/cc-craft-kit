...
- [ ] `.github/workflows/release.yml` のアーカイブ生成ロジックを修正 (#615)
- [ ] ローカルでアーカイブを生成し構造を検証 (#616)

### Phase 2: テスト・検証

- [ ] 生成したアーカイブで install.sh を実行してエラーが解消されることを確認 (#617)
- [ ] 展開後のディレクトリ構造が正しいことを確認 (#618)
