---
id: "7d808ccf-23d0-4dfe-9fa9-0d33e81f5098"
name: "/cft:spec-phase コマンドの見直し"
phase: "completed"
branch_name: "main"
github_issue_number: null
pr_url: null
created_at: "2025-11-25T02:22:40.794Z"
updated_at: "2025-11-25T11:39:56Z"
---
...
- [x] resolve-id.ts スクリプトを新規作成
- [x] update-phase.ts スクリプトを簡略化

### 本体タスク

- [x] spec-phase.md をプロンプトファースト版に更新
- [x] バリデーションロジックをプロンプト内で実装（プロンプトに記載）
- [x] pr-creator スキルとの連携を実装（プロンプトに記載）
- [x] 各フェーズ固有の後処理を実装（プロンプトに記載）

### テストタスク

- [x] resolve-id.ts の単体テストを作成（import.meta 制約あり、testPathIgnorePatterns 追加）
- [x] update-phase.ts の単体テストを更新（import.meta 制約あり、testPathIgnorePatterns 追加）
- [ ] 統合テストを追加

### クリーンアップタスク

- [ ] 旧 phase.ts の不要コードを削除（互換性のため保持）
- [ ] ドキュメントを更新
---
...
**PR 番号:** #360
**PR URL:** https://github.com/B16B1RD/cc-craft-kit/pull/360
**PR 作成日時:** 2025/11/25 11:42:00
