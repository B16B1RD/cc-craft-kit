...
- [ ] pr-creator にドラフト PR を Ready に変更する手順を追加 (#805)
- [ ] pr-creator に cc-craft-kit 統合セクションを追加 (#806)
- [ ] pr-creator に関連スキル/サブエージェントセクションを追加 (#807)

### Phase 2: database-schema-validator の改善

- [ ] database-schema-validator に cc-craft-kit 固有スキーマ参照を追加 (#808)
- [ ] database-schema-validator に cc-craft-kit 統合セクションを追加 (#809)
- [ ] database-schema-validator に関連スキル/サブエージェントセクションを追加 (#810)

### Phase 3: git-operations の改善

- [ ] git-operations に cc-craft-kit ブランチ戦略セクションを追加 (#811)
- [ ] git-operations に cc-craft-kit 統合セクションを追加 (#812)
- [ ] git-operations に関連スキル/サブエージェントセクションを追加 (#813)
