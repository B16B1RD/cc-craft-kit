---
id: "323b19cb-a6ce-4af8-8717-99c50cc8a501"
name: "v0.1.3 リリース準備"
phase: "completed"
branch_name: "develop"
github_issue_number: null
pr_url: null
created_at: "2025-11-29T11:32:11.594Z"
updated_at: "2025-11-29T22:53:00Z"
---
...
- [x] package.json の version を `0.1.3` に更新
- [x] CHANGELOG.md に v0.1.3 セクションを追加
- [x] src/commands/utils/error-handler.ts の validPhases から `tasks` を削除

### Phase 2: 品質チェック

- [x] `npm run sync:dogfood` で同期実行
- [x] `npm run typecheck` で型チェック実行
- [x] `npm run lint` でリント実行
- [x] `npm test` で全テスト実行

### Phase 3: リリース

- [x] develop → main への PR 作成
  - feature ブランチ PR: https://github.com/B16B1RD/cc-craft-kit/pull/430
- [x] Git タグ `v0.1.3` を作成
