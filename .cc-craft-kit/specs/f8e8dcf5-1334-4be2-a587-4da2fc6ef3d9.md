---
id: "f8e8dcf5-1334-4be2-a587-4da2fc6ef3d9"
name: "構成見直し"
phase: "completed"
branch_name: "develop"
github_issue_number: null
pr_url: null
created_at: "2025-12-05T03:43:04.599Z"
updated_at: "2025-12-05T04:32:15.049Z"
---
...
- [x] output.ts の依存関係を調査（多数の依存があるため保持） (#822)
- [x] agent/list.ts を削除し、/cft:custom-tools に一覧表示機能を統合 (#823)
- [x] agent/create.ts を削除し、/cft:custom-tools にテンプレート生成機能を統合 (#824)
- [x] skill/list.ts を削除し、/cft:custom-tools に一覧表示機能を統合 (#825)
- [x] skill/create.ts を削除し、/cft:custom-tools にテンプレート生成機能を統合 (#826)
- [x] utils/validation.ts の機能をプロンプト層に移行 (#827)
- [x] Phase 1 完了後の型チェック・ESLint・テスト実行 (#828)

### Phase 2: TypeScript スキル/サブエージェントのマークダウン化

- [x] architecture-diagram-generator.ts をマークダウンスキルに変換 (#829)
