---
id: "0b6eb481-9519-4db9-b646-268334ad7da3"
name: "PR の作成はドラフト状態で作成"
phase: "completed"
branch_name: "develop"
github_issue_number: null
pr_url: null
created_at: "2025-11-30T16:14:38.598Z"
updated_at: "2025-12-01T20:14:00Z"
---
...
- [x] pr-creator スキルの `gh pr create` コマンドに `--draft` フラグを追加
- [x] pr-creator スキルのドキュメントにドラフト PR 作成の説明を追記

### Phase 2: task.md done サブコマンド変更

- [x] task.md の `gh pr create` コマンドに `--draft` フラグを追加
- [x] `--draft` フラグのロジックを `--ready` フラグに反転
- [x] task.md のドキュメントにフラグの説明を追記

### Phase 3: 検証

- [x] pr-creator スキルで Draft PR が作成されることを確認
- [x] task done でデフォルトで Draft PR が作成されることを確認
- [x] `--ready` フラグで Ready 状態の PR が作成されることを確認
---

## Pull Request

- https://github.com/B16B1RD/cc-craft-kit/pull/471
