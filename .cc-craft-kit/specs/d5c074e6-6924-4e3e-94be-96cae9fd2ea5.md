---
id: "d5c074e6-6924-4e3e-94be-96cae9fd2ea5"
name: "フェーズおよび Issue ステータスの見直し"
phase: "completed"
branch_name: "develop"
github_issue_number: null
pr_url: null
created_at: "2025-12-04T02:06:56.146Z"
...
- [x] phase.ts に review フェーズのガイダンスを追加 (#630)

### Phase 3: コマンド統合

- [x] phase.md の Step 8 を更新（review フェーズで PR 作成） (#631)
- [x] pr-cleanup.ts に廃止警告と completed フェーズへの誘導を追加 (#632)

### Phase 4: 動作確認

- [x] npm run typecheck && npm run lint でエラーがないことを確認 (#633)
- [x] npm run sync:dogfood で変更を同期 (#634)
---

## Pull Request

- https://github.com/B16B1RD/cc-craft-kit/pull/635
