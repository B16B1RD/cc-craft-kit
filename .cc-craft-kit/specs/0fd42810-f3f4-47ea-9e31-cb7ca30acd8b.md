---
id: "0fd42810-f3f4-47ea-9e31-cb7ca30acd8b"
name: "Sub Issue を活用"
phase: "completed"
branch_name: "main"
github_issue_number: null
pr_url: null
created_at: "2025-11-18T11:55:20Z"
updated_at: "2025-11-18T14:58:25Z"
---
...
- [ ] `/cft:spec-phase <spec-id> tasks` 実行時、「8. 実装タスクリスト」の各タスクが Sub Issue として自動作成される
...
- [ ] 既存の GitHub 統合（`/cft:github-issue-create`, `/cft:github-sync`）と互換性を保つ
...
```
┌─────────────────────────────────────────────────────────┐
│  Slash Command: /cft:spec-phase <id> tasks    │
└─────────────────────┬───────────────────────────────────┘
                      │
                      ▼
┌─────────────────────────────────────────────────────────┐
