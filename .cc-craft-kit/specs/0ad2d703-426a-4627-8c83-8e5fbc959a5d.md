...
- [ ] spec-create.md の Step 7 を Step 9 に移動（DB 登録）
- [ ] spec-create.md の Step 8 を Step 7 に移動（コードベース解析）
- [ ] spec-create.md の Step 9 を Step 8 に移動（仕様書自動完成）
- [ ] ロールバック処理の順序を調整
- [ ] sync:dogfood で同期
- [ ] `/cft:spec-create` を実行して動作確認
