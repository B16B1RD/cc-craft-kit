...
### GitHub Projects の自動化機能

- [ ] GitHub Projects に「Sub Issue がすべてクローズされたら親 Issue を Done にする」自動化ルールが存在するか確認
- [ ] 該当リポジトリの GitHub Projects の Workflow 設定を確認
- [ ] cc-craft-kit の明示的なステータス更新と GitHub 側の自動化が競合していないか確認
