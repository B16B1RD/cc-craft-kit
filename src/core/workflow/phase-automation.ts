...
export class PhaseAutomationHandler {
   ...
   */
  private async handleRequirementsPhase(_specId: string): Promise<void> {
   ...
   * - 不足情報がある場合は、Claude が AskUserQuestion で問い合わせる
   */
  private async handleDesignPhase(_specId: string): Promise<void> {
   ...
   */
  private async handleTasksPhase(_specId: string): Promise<void> {
   ...
   */
  private async handleImplementationPhase(_specId: string): Promise<void> {
   ...
   */
  private async handleCompletedPhase(_specId: string): Promise<void> {
