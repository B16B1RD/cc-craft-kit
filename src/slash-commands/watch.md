...
仕様書ファイル（`.takumi/specs/*.md`）の変更を監視し、変更があった場合に自動的に GitHub Issue に更新通知を送信します。
...
```bash
npx tsx .takumi/commands/watch.ts
```
