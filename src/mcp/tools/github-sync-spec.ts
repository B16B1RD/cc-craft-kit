 ...
 */
export const syncSpecToGitHubTool: Tool & { handler: (params: any) => Promise<any> } = {
 ...
 */
export const syncGitHubToSpecTool: Tool & { handler: (params: any) => Promise<any> } = {
 ...
 * 仕様書をProjectに追加ツール
 */
export const addSpecToProjectTool: Tool & { handler: (params: any) => Promise<any> } = {
